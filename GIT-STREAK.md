...
Endpoint: https://geekageddon-api.vercel.app/gitstreak?user=your-githubUsername
...
| Description | Example |
|------------|---------|
| Basic SVG card | https://geekageddon-api.vercel.app/gitstreak?user=sanchivarma&format=svg&user=octocat |
| With theme | https://geekageddon-api.vercel.app/gitstreak?user=sanchivarma&format=svg&theme=dracula&user=octocat |
| With graph | https://geekageddon-api.vercel.app/gitstreak?user=sanchivarma&format=svg&showgraph=true&user=octocat |
| With border animation | https://geekageddon-api.vercel.app/gitstreak?user=sanchivarma&format=svg&borderAnimation=rainbow&user=octocat |
| JSON stats + SVG string | https://geekageddon-api.vercel.app/gitstreak?user=sanchivarma&user=octocat |
